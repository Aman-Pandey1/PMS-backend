...
type DocType = 'AADHAAR'|'PAN'|'PHOTO'|'BANK';

export default function DocumentsPage() {
  const [docs, setDocs] = useState<{ type: DocType; name: string }[]>([]);
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-2 items-center">
        <select className="border rounded px-3 py-2" value={type} onChange={(e) => setType(e.target.value as DocType)}>
