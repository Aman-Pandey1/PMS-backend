...
export async function listUsers(companyId) {
	...
	return data.items.map((u) => ({ id: u._id || u.id, email: u.email, fullName: u.fullName, role: u.role, companyId: u.companyId, managerId: u.managerId, jobPosition: u.jobPosition, isActive: u.isActive }));
}
